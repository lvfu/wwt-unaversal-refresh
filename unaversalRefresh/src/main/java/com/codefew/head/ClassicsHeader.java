...
public class ClassicsHeader extends RelativeLayout implements RefreshHeadable {
...
//    public static String REFRESH_HEADER_LASTTIME = "'Last update' M-d HH:mm";
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        mRefreshStyle = RefreshStyle.values()[ta.getInt(R.styleable.ClassicsHeader_srlClassicsSpinnerStyle,mRefreshStyle.ordinal())];
    ...
    public ClassicsHeader setRefreshStyle(RefreshStyle style) {
