...
import com.codefew.head.material.CircleImageView;
import com.codefew.head.material.MaterialProgressDrawable;
...
/**
 * Created by flowing on 2018/2/23.
 * @version 1.0
 * @author wangwentao
 * 官方主题
 */

public class MaterialHeader extends ViewGroup implements RefreshHeadable {
...
//                resolveSize(getSuggestedMinimumHeight(), heightMeasureSpec));
    ...
    @Override
    public void onStartAnimator(@NonNull Refreshable layout, int height, int extendHeight) {
    ...
    public RefreshStyle getRefreshStyle() {
        return RefreshStyle.MatchLayout;
    }
