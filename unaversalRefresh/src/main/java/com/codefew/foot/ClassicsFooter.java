...
import com.codefew.view.PathsDrawable;
import com.codefew.view.ProgressDrawable;
...
public class ClassicsFooter extends RelativeLayout implements RefreshFootable{
    ...
    protected RefreshStyle mRefreshStyle = RefreshStyle.Translate;
    ...
    private void initView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mRefreshStyle = RefreshStyle.values()[ta.getInt(R.styleable.ClassicsFooter_srlClassicsSpinnerStyle, mRefreshStyle.ordinal())];
    ...
    public int onFinish(@NonNull Refreshable layout, boolean success) {
        if (!mLoadmoreFinished) {
            if (mProgressDrawable != null) {
                ...
                mProgressView.animate().rotation(0).setDuration(100);
            }
            mProgressView.setVisibility(GONE);
            if (success) {
    ...
    public void setPrimaryColors(@ColorInt int ... colors) {
        if (mRefreshStyle == RefreshStyle.FixedBehind) {
            if (colors.length > 0) {
...
//                    replaceRefreshLayoutBackground(refreshLayout);
    ...
    public ClassicsFooter setSpinnerStyle(RefreshStyle style) {
        this.mRefreshStyle = style;
        return this;
    }
