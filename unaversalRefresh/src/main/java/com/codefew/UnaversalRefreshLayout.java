...
import com.codefew.api.DefaultRefreshFooterCreater;
import com.codefew.api.DefaultRefreshHeederCreater;
import com.codefew.api.RefreshContentable;
...
import com.codefew.util.DelayedRunable;
import com.codefew.util.DensityUtil;
import com.codefew.util.ViscousFluidInterpolator;
import com.codefew.wrapper.RefreshContentWrapper;
import com.codefew.wrapper.RefreshFooterWrapper;
import com.codefew.wrapper.RefreshHeaderWrapper;
...
import static com.codefew.util.DensityUtil.dp2px;
...
public class UnaversalRefreshLayout extends ViewGroup implements NestedScrollingChild,NestedScrollingParent, Refreshable {
     ...
     * 下拉头部视图
     */
    protected RefreshHeadable mRefreshHeader;
    /**
     * 上拉底部视图
     */
    protected RefreshFootable mRefreshFooter;
    /**
     * 显示内容视图
     */
    protected RefreshContentable mRefreshContent;
    //</editor-fold>
    ...
    protected static boolean sManualFooterCreater = false;
        ...
        protected static DefaultRefreshFooterCreater sFooterCreater = new DefaultRefreshFooterCreater() {
            @NonNull
            @Override
            public RefreshFootable createRefreshFooter(Context context, Refreshable layout) {
                return new BallPulseFooter(context);
            }


        };
        protected static DefaultRefreshHeederCreater sHeaderCreater = new DefaultRefreshHeederCreater() {
            @NonNull
            @Override
            public RefreshHeadable createRefreshHeader(Context context, Refreshable layout) {
        ...
        public UnaversalRefreshLayout(Context context, AttributeSet attrs) {
            super(context, attrs);
            this.initView(context, attrs);
        }

        public UnaversalRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr) {
            super(context, attrs, defStyleAttr);
            this.initView(context, attrs);
        }

        @RequiresApi(Build.VERSION_CODES.LOLLIPOP)
        public UnaversalRefreshLayout(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        ...
        protected void onFinishInflate() {
            ...
            for (int i = 0; i < count; i++) {
                ...
                if (view instanceof RefreshHeadable && mRefreshHeader == null) {
                    mRefreshHeader = ((RefreshHeadable) view);
                } else if (view instanceof RefreshFootable && mRefreshFooter == null) {
                    mEnableLoadmore = mEnableLoadmore || !mManualLoadmore;
                    mRefreshFooter = ((RefreshFootable) view);
            ...
            if (isInEditMode()) {
                ...
                if (mRefreshHeader != null && mRefreshHeader.getRefreshStyle() != RefreshStyle.FixedBehind) {
                    bringChildToFront(mRefreshHeader.getView());
                }
                if (mRefreshFooter != null && mRefreshFooter.getRefreshStyle() != RefreshStyle.FixedBehind) {
        ...
        protected void onAttachedToWindow() {
            ...
            if (mRefreshHeader == null) {
                ...
                if (!(mRefreshHeader.getView().getLayoutParams() instanceof MarginLayoutParams)) {
                    if (mRefreshHeader.getRefreshStyle() == RefreshStyle.Scale) {
            ...
            if (mRefreshFooter == null) {
                ...
                if (!(mRefreshFooter.getView().getLayoutParams() instanceof MarginLayoutParams)) {
                    if (mRefreshFooter.getRefreshStyle() == RefreshStyle.Scale) {
            ...
            //重新排序
            bringChildToFront(mRefreshContent.getView());
            if (mRefreshHeader.getRefreshStyle() != RefreshStyle.FixedBehind) {
                bringChildToFront(mRefreshHeader.getView());
            }
            if (mRefreshFooter.getRefreshStyle() != RefreshStyle.FixedBehind) {
                bringChildToFront(mRefreshFooter.getView());
            }
            ...
            if (mRefreshListener == null) {
                mRefreshListener = new OnRefreshListener() {
                    @Override
                    public void onRefresh(Refreshable refreshlayout) {
            ...
            if (mLoadmoreListener == null) {
                mLoadmoreListener = new OnLoadmoreListener() {
                    ...
                    public void onLoadMore(Refreshable refreshable) throws Exception {
                        refreshable.finishLoadmore(2000);
        ...
        protected void onMeasure(final int widthMeasureSpec,final int heightMeasureSpec) {
            ...
            for (int i = 0, len = getChildCount(); i < len; i++) {
                ...
                if (mRefreshHeader != null && mRefreshHeader.getView() == child) {
                    ...
                    } else if (mRefreshHeader.getRefreshStyle() == RefreshStyle.MatchLayout) {
                        int headerHeight = 0;
                    ...
                    if (mRefreshHeader.getRefreshStyle() == RefreshStyle.Scale && !isInEditMode) {
                ...
                if (mRefreshFooter != null && mRefreshFooter.getView() == child) {
                    ...
                    } else if (mRefreshFooter.getRefreshStyle() == RefreshStyle.MatchLayout) {
                        int footerHeight = 0;
                    ...
                    if (mRefreshFooter.getRefreshStyle() == RefreshStyle.Scale && !isInEditMode) {
                ...
                if (mRefreshContent != null && mRefreshContent.getView() == child) {
                    ...
                    final int heightSpec = getChildMeasureSpec(heightMeasureSpec,
                            getPaddingTop() + getPaddingBottom() +
                                    ...
                                    ((isInEditMode && isEnableRefresh() && (mEnableHeaderTranslationContent || mRefreshHeader.getRefreshStyle() == RefreshStyle.FixedBehind)) ? mHeaderHeight : 0) +
                                    ((isInEditMode && isEnableLoadmore() && (mEnableFooterTranslationContent || mRefreshFooter.getRefreshStyle() == RefreshStyle.FixedBehind)) ? mFooterHeight : 0), lp.height);
        ...
        protected void onLayout(boolean changed, int l, int t, int r, int b) {
            ...
            for (int i = 0, len = getChildCount(); i < len; i++) {
                ...
                if (mRefreshContent != null && mRefreshContent.getView() == child) {
                    ...
                    if (isInEditMode && isEnableRefresh() && (mEnableHeaderTranslationContent || mRefreshHeader.getRefreshStyle() == RefreshStyle.FixedBehind)) {
                ...
                if (mRefreshHeader != null && mRefreshHeader.getView() == child) {
                    ...
                    if (!isInEditMode) {
                        if (mRefreshHeader.getRefreshStyle() == RefreshStyle.Translate) {
                            top = top - mHeaderHeight;// + Math.max(0, isEnableRefresh() ? mSpinner : 0);
                            bottom = top + headerView.getMeasuredHeight();
                        } else if (mRefreshHeader.getRefreshStyle() == RefreshStyle.Scale) {
                ...
                if (mRefreshFooter != null && mRefreshFooter.getView() == child) {
                    ...
                    final View footerView = mRefreshFooter.getView();
                    final LayoutParams lp = (LayoutParams) footerView.getLayoutParams();
                    final RefreshStyle style = mRefreshFooter.getRefreshStyle();
                    int left = lp.leftMargin;
                    int top = lp.topMargin + getMeasuredHeight() - lp.bottomMargin;

                    if (isInEditMode
                            || style == RefreshStyle.FixedFront
                            || style == RefreshStyle.FixedBehind) {
                        top = top - mFooterHeight;
                    } else if (style == RefreshStyle.Scale/* || style == SpinnerStyle.Translate*/) {
                ...
                case MotionEvent.ACTION_CANCEL:
                    ...
                    if (overSpinner()) {
                        ...
                        if (Math.abs(velocity) > mMinimumVelocity && velocity * mSpinner > 0) {
                            animSpinner(0);
                            if (mRefreshContent != null) {
                                mRefreshContent.flying((int) velocity);
        ...
        protected void setStateDirectLoading() {
            if (mState != RefreshState.Loading) {
                ...
                mFooterLocked = true;
                if (mRefreshFooter != null) {
                    mRefreshFooter.onStartAnimator(UnaversalRefreshLayout.this, mFooterHeight, mFooterExtendHeight);
                }
                if (mLoadmoreListener != null) {
                    try {
                        mLoadmoreListener.onLoadMore(UnaversalRefreshLayout.this);
                    } catch (Exception e) {
                        e.printStackTrace();
                    }
                }
                if (mOnMultiPurposeListener != null) {
                    try {
                        mOnMultiPurposeListener.onLoadMore(UnaversalRefreshLayout.this);
        ...
        protected void setStateRefreshing() {
            AnimatorListenerAdapter listener = new AnimatorListenerAdapter() {
                ...
                public void onAnimationEnd(Animator animation) {
                    ...
                    if (mRefreshListener != null) {
                        try {
                            mRefreshListener.onRefresh(UnaversalRefreshLayout.this);
                        } catch (Exception e) {
                            e.printStackTrace();
                        }
                    }
                    if (mRefreshHeader != null) {
                        mRefreshHeader.onStartAnimator(UnaversalRefreshLayout.this, mHeaderHeight, mHeaderExtendHeight);
                    }
                    if (mOnMultiPurposeListener != null) {
                        try {
                            mOnMultiPurposeListener.onRefresh(UnaversalRefreshLayout.this);
        ...
        protected void moveSpinner(final int spinner, boolean isAnimator) {
            ...
            if (mRefreshContent != null) {
                ...
                if (spinner >= 0) {
                    if (mEnableHeaderTranslationContent || mRefreshHeader == null || mRefreshHeader.getRefreshStyle() == RefreshStyle.FixedBehind) {
                        tspinner = spinner;
                ...
                if (spinner <= 0) {
                    if (mEnableFooterTranslationContent || mRefreshFooter == null || mRefreshFooter.getRefreshStyle() == RefreshStyle.FixedBehind) {
                        tspinner = spinner;
                    } else if (oldSpinner > 0) {
                        tspinner = 0;
                    }
            ...
            if ((spinner <= 0 || oldSpinner < 0) && mRefreshFooter != null) {
                ...
                if (isEnableLoadmore() || (mState == RefreshState.LoadFinish && isAnimator)) {
                    if (oldSpinner != mSpinner) {
                        if (mRefreshFooter.getRefreshStyle() == RefreshStyle.Translate) {
                            mRefreshFooter.getView().setTranslationY(mSpinner);
                        } else if (mRefreshFooter.getRefreshStyle() == RefreshStyle.Scale){
        ...
        public static class LayoutParams extends MarginLayoutParams {
            ...
            public LayoutParams(Context context, AttributeSet attrs) {
                ...
                if (ta.hasValue(R.styleable.SmartRefreshLayout_Layout_layout_srlSpinnerStyle)) {
                    spinnerStyle = RefreshStyle.values()[ta.getInt(R.styleable.SmartRefreshLayout_Layout_layout_srlSpinnerStyle, RefreshStyle.Translate.ordinal())];
                }
                ta.recycle();
            }
            ...
            public RefreshStyle spinnerStyle = null;
        }
        //</editor-fold>
...
//        }
        ...
        @Override
        public UnaversalRefreshLayout setFooterHeight(float heightDp) {
            return setFooterHeightPx(dp2px(heightDp));
        }

        @Override
        public UnaversalRefreshLayout setFooterHeightPx(int heightPx) {
        ...
        @Override
        public UnaversalRefreshLayout setHeaderHeight(float heightDp) {
            return setHeaderHeightPx(dp2px(heightDp));
        }

        @Override
        public UnaversalRefreshLayout setHeaderHeightPx(int heightPx) {
        ...
        @Override
        public UnaversalRefreshLayout setDragRate(float rate) {
            this.mDragRate = rate;
            return this;
        }
         ...
         */
        @Override
        public UnaversalRefreshLayout setHeaderMaxDragRate(float rate) {
         ...
         */
        @Override
        public UnaversalRefreshLayout setFooterMaxDragRate(float rate) {
         ...
         */
        @Override
        public UnaversalRefreshLayout setHeaderTriggerRate(float rate) {
         ...
         */
        @Override
        public UnaversalRefreshLayout setFooterTriggerRate(float rate) {
         ...
         */
        @Override
        public UnaversalRefreshLayout setReboundInterpolator(Interpolator interpolator) {
         ...
         */
        @Override
        public UnaversalRefreshLayout setReboundDuration(int duration) {
         ...
         */
        @Override
        public UnaversalRefreshLayout setEnableLoadmore(boolean enable) {
         ...
         */
        @Override
        public UnaversalRefreshLayout setEnableRefresh(boolean enable) {
         ...
         */
        @Override
        public UnaversalRefreshLayout setEnableHeaderTranslationContent(boolean enable) {
         ...
         */
        @Override
        public UnaversalRefreshLayout setEnableFooterTranslationContent(boolean enable) {
         ...
         */
        @Override
        public UnaversalRefreshLayout setDisableContentWhenRefresh(boolean disable) {
         ...
         */
        @Override
        public UnaversalRefreshLayout setDisableContentWhenLoading(boolean disable) {
         ...
         */
        @Override
        public UnaversalRefreshLayout setEnableAutoLoadmore(boolean enable) {
         ...
         */
        @Override
        public UnaversalRefreshLayout setEnableOverScrollBounce(boolean enable) {
         ...
         */
        @Override
        public UnaversalRefreshLayout setEnablePureScrollMode(boolean enable) {
         ...
         */
        @Override
        public UnaversalRefreshLayout setEnableScrollContentWhenLoaded(boolean enable) {
         ...
         */
        @Override
        public UnaversalRefreshLayout setEnableScrollContentWhenRefreshed(boolean enable) {
         ...
         */
        @Override
        public UnaversalRefreshLayout setEnableLoadmoreWhenContentNotFull(boolean enable) {
         ...
         */
        @Override
        public UnaversalRefreshLayout setEnableOverScrollDrag(boolean enable) {
         ...
         */
        @Override
        public UnaversalRefreshLayout setEnableFooterFollowWhenLoadFinished(boolean enable) {
         ...
         */
        @Override
        public Refreshable setEnableNestedScroll(boolean enabled) {
         ...
         */
        @Override
        public UnaversalRefreshLayout setRefreshHeader(RefreshHeadable header) {
         ...
         */
        @Override
        public UnaversalRefreshLayout setRefreshHeader(RefreshHeadable header, int width, int height) {
            if (header != null) {
                if (mRefreshHeader != null) {
                ...
                if (header.getRefreshStyle() == RefreshStyle.FixedBehind) {
         ...
         */
        @Override
        public UnaversalRefreshLayout setRefreshFooter(RefreshFootable footer) {
         ...
         */
        @Override
        public UnaversalRefreshLayout setRefreshFooter(RefreshFootable footer, int width, int height) {
            if (footer != null) {
                if (mRefreshFooter != null) {
         ...
         */
        @Override
        public Refreshable setRefreshContent(View content) {
         ...
         */
        @Override
        public Refreshable setRefreshContent(View content, int width, int height) {
            if (content != null) {
                if (mRefreshContent != null) {
                ...
                } else if (mRefreshFooter != null && mRefreshFooter.getRefreshStyle() == RefreshStyle.FixedBehind) {
                    bringChildToFront(content);
                    if (mRefreshHeader != null && mRefreshHeader.getRefreshStyle() == RefreshStyle.FixedBehind) {
                        bringChildToFront(mRefreshHeader.getView());
                    }
        ...
        @Nullable
        @Override
        public RefreshFootable getRefreshFooter() {
        ...
        @Nullable
        @Override
        public RefreshHeadable getRefreshHeader() {
         ...
         */
        @Override
        public UnaversalRefreshLayout setOnRefreshListener(OnRefreshListener listener) {
         ...
         */
        @Override
        public UnaversalRefreshLayout setOnLoadmoreListener(OnLoadmoreListener listener) {
    ...
    /**
         ...
         */
        @Override
        public UnaversalRefreshLayout setOnRefreshLoadmoreListener(OnRefreshLoadmoreListener listener) {
            this.mRefreshListener = listener;
            this.mLoadmoreListener = listener;
            this.mEnableLoadmore = mEnableLoadmore || (!mManualLoadmore && listener != null);
            return this;
         ...
         */
        @Override
        public UnaversalRefreshLayout setOnMultiPurposeListener(OnMultiPurposeListener listener) {
         ...
         */
        @Override
        public UnaversalRefreshLayout setPrimaryColorsId(@ColorRes int... primaryColorId) {
         ...
         */
        @Override
        public UnaversalRefreshLayout setPrimaryColors(int... colors) {
            if (mRefreshHeader != null) {
         ...
         */
        @Override
        public Refreshable setScrollBoundaryDecider(ScrollBoundaryDecider boundary) {
         ...
         */
        @Override
        public UnaversalRefreshLayout setLoadmoreFinished(boolean finished) {
    ...
    /**
         ...
         */
        @Override
        public UnaversalRefreshLayout finishRefresh() {
         ...
         */
        @Override
        public UnaversalRefreshLayout finishLoadmore() {
            long passTime = System.currentTimeMillis() - mLastLoadingTime;
            return finishLoadmore(Math.max(0, 100 - (int) passTime));//保证加载动画有1000毫秒的时间
        }
         ...
         */
        @Override
        public UnaversalRefreshLayout finishRefresh(int delayed) {
         ...
         */
        @Override
        public UnaversalRefreshLayout finishRefresh(boolean success) {
            long passTime = System.currentTimeMillis() - mLastRefreshingTime;
         ...
         */
        @Override
        public UnaversalRefreshLayout finishRefresh(int delayed, final boolean success) {
            postDelayed(new Runnable() {
                @Override
                public void run() {
                    if (mState == RefreshState.Refreshing) {
                        if (mRefreshHeader != null && mRefreshContent != null) {
                            int startDelay = mRefreshHeader.onFinish(UnaversalRefreshLayout.this, success);
         ...
         */
        @Override
        public UnaversalRefreshLayout finishLoadmore(int delayed) {
         ...
         */
        @Override
        public UnaversalRefreshLayout finishLoadmore(boolean success) {
            long passTime = System.currentTimeMillis() - mLastLoadingTime;
         ...
         */
        @Override
        public UnaversalRefreshLayout finishLoadmore(int delayed, final boolean success) {
         ...
         */
        @Override
        public UnaversalRefreshLayout finishLoadmore(int delayed, final boolean success, final boolean noMoreData) {
            postDelayed(new Runnable() {
                @Override
                public void run() {
                    if (mState == RefreshState.Loading) {
                        if (mRefreshFooter != null && mRefreshContent != null) {
                            final int startDelay = mRefreshFooter.onFinish(UnaversalRefreshLayout.this, success);
                            if (startDelay < Integer.MAX_VALUE) {
                                if (mIsBeingDragged) {
                                    mTouchSpinner = 0;
                                    mTouchY = mLastTouchY;
         ...
         */
        @Override
        public UnaversalRefreshLayout finishLoadmoreWithNoMoreData() {
            long passTime = System.currentTimeMillis() - mLastLoadingTime;
         ...
         */
        @Override
        public UnaversalRefreshLayout resetNoMoreData() {
         ...
         * 设置默认Header构建器
         */
        public static void setDefaultRefreshHeaderCreater(@NonNull DefaultRefreshHeederCreater creater) {
        ...
        public class RefreshKernelImpl implements RefreshKernel {
            ...
            @NonNull
            @Override
            public RefreshContentable getRefreshContent() {
            ...
            public RefreshKernel setState(@NonNull RefreshState state) {
                switch (state) {
                    case None:
                        UnaversalRefreshLayout.this.resetStatus();
                        break;
                    case PullDownToRefresh:
                        UnaversalRefreshLayout.this.setStatePullDownToRefresh();
                        break;
                    case PullToUpLoad:
                        UnaversalRefreshLayout.this.setStatePullUpToLoad();
                        break;
                    case PullDownCanceled:
                        UnaversalRefreshLayout.this.setStatePullDownCanceled();
                        break;
                    case PullUpCanceled:
                        UnaversalRefreshLayout.this.setStatePullUpCanceled();
                        break;
                    case ReleaseToRefresh:
                        UnaversalRefreshLayout.this.setStateReleaseToRefresh();
                        break;
                    case ReleaseToLoad:
                        UnaversalRefreshLayout.this.setStateReleaseToLoad();
                        break;
                    case ReleaseToTwoLevel: {
                        if (!UnaversalRefreshLayout.this.mState.opening && UnaversalRefreshLayout.this.isEnableRefresh()) {
                            UnaversalRefreshLayout.this.notifyStateChanged(RefreshState.ReleaseToTwoLevel);
                        } else {
                            UnaversalRefreshLayout.this.setViceState(RefreshState.ReleaseToTwoLevel);
                        }
                        break;
                    }
                    case RefreshReleased: {
                        if (!UnaversalRefreshLayout.this.mState.opening && UnaversalRefreshLayout.this.isEnableRefresh()) {
                            UnaversalRefreshLayout.this.notifyStateChanged(RefreshState.RefreshReleased);
                        } else {
                            UnaversalRefreshLayout.this.setViceState(RefreshState.RefreshReleased);
                        }
                        break;
                    }
                    case LoadReleased: {
                        if (!UnaversalRefreshLayout.this.mState.opening && UnaversalRefreshLayout.this.isEnableLoadmore()) {
                            UnaversalRefreshLayout.this.notifyStateChanged(RefreshState.LoadReleased);
                        } else {
                            UnaversalRefreshLayout.this.setViceState(RefreshState.LoadReleased);
                        }
                        break;
                    }
                    case Refreshing:
                        UnaversalRefreshLayout.this.setStateRefreshing();
                        break;
                    case Loading:
                        UnaversalRefreshLayout.this.setStateLoding();
                        break;
                    case RefreshFinish: {
                        if (UnaversalRefreshLayout.this.mState == RefreshState.Refreshing) {
                            UnaversalRefreshLayout.this.notifyStateChanged(RefreshState.RefreshFinish);
                        }
                        break;
                    }
                    case LoadFinish:{
                        if (UnaversalRefreshLayout.this.mState == RefreshState.Loading) {
                            UnaversalRefreshLayout.this.notifyStateChanged(RefreshState.LoadFinish);
                        }
                        break;
                    }
                }
            ...
            public RefreshKernel startTwoLevel(boolean open) {
                if (open) {
                    AnimatorListenerAdapter listener = new AnimatorListenerAdapter() {
                        @Override
                        public void onAnimationEnd(Animator animation) {
                            UnaversalRefreshLayout.this.notifyStateChanged(RefreshState.TwoLevel);
                        }
                    };
                    ValueAnimator animator = UnaversalRefreshLayout.this.animSpinner(UnaversalRefreshLayout.this.getMeasuredHeight());
                    if (animator != null && animator == UnaversalRefreshLayout.this.reboundAnimator) {
                        animator.setDuration(UnaversalRefreshLayout.this.mFloorDuration);
                        animator.addListener(listener);
                    } else {
                        listener.onAnimationEnd(null);
                    }
                    ...
                    if (animSpinner(0) == null) {
                        UnaversalRefreshLayout.this.notifyStateChanged(RefreshState.None);
                    }
                }
                return this;
            }
            ...
            public RefreshKernel finishTwoLevel() {
                if (UnaversalRefreshLayout.this.mState == RefreshState.TwoLevel) {
                    UnaversalRefreshLayout.this.notifyStateChanged(RefreshState.TwoLevelFinish);
                    if (UnaversalRefreshLayout.this.mSpinner == 0) {
                        moveSpinner(0, true);
                        UnaversalRefreshLayout.this.notifyStateChanged(RefreshState.None);
                    } else {
                        UnaversalRefreshLayout.this.animSpinner(0).setDuration(UnaversalRefreshLayout.this.mFloorDuration);
                    }
                }
                return this;
            }
            ...
            public RefreshKernel moveSpinner(int spinner, boolean isAnimator) {
                UnaversalRefreshLayout.this.moveSpinner(spinner, isAnimator);
                return this;
            }

            public RefreshKernel animSpinner(int endSpinner) {
                UnaversalRefreshLayout.this.animSpinner(endSpinner);
                return this;
            }
            ...
            public RefreshKernel requestDrawBackgoundForHeader(int backgroundColor) {
                if (UnaversalRefreshLayout.this.mPaint == null && backgroundColor != 0) {
                    UnaversalRefreshLayout.this.mPaint = new Paint();
                }
                UnaversalRefreshLayout.this.mHeaderBackgroundColor = backgroundColor;
                return this;
            }
            ...
            public RefreshKernel requestDrawBackgoundForFooter(int backgroundColor) {
                ...
                UnaversalRefreshLayout.this.mFooterBackgroundColor = backgroundColor;
                return this;
            }
            @Override
            public RefreshKernel requestHeaderNeedTouchEventWhenRefreshing(boolean request) {
                UnaversalRefreshLayout.this.mHeaderNeedTouchEventWhenRefreshing = request;
                return this;
            }
            @Override
            public RefreshKernel requestFooterNeedTouchEventWhenLoading(boolean request) {
                UnaversalRefreshLayout.this.mFooterNeedTouchEventWhenLoading = request;
                return this;
            }
            @Override
            public RefreshKernel requestDefaultHeaderTranslationContent(boolean translation) {
                if (!UnaversalRefreshLayout.this.mManualHeaderTranslationContent) {
                    UnaversalRefreshLayout.this.mManualHeaderTranslationContent = true;
                    UnaversalRefreshLayout.this.mEnableHeaderTranslationContent = translation;
                }
                return this;
            }
            @Override
            public RefreshKernel requestRemeasureHeightForHeader() {
                if (UnaversalRefreshLayout.this.mHeaderHeightStatus.notifyed) {
                    UnaversalRefreshLayout.this.mHeaderHeightStatus = UnaversalRefreshLayout.this.mHeaderHeightStatus.unNotify();
                }
                return this;
            }
            @Override
            public RefreshKernel requestRemeasureHeightForFooter() {
                if (UnaversalRefreshLayout.this.mFooterHeightStatus.notifyed) {
                    UnaversalRefreshLayout.this.mFooterHeightStatus = UnaversalRefreshLayout.this.mFooterHeightStatus.unNotify();
                }
                return this;
            }
            @Override
            public RefreshKernel requestFloorDuration(int duration) {
                UnaversalRefreshLayout.this.mFloorDuration = duration;
                return this;
            }
            //</editor-fold>
        }
