...
import static com.codefew.util.ScrollBoundaryUtil.canScrollDown;
import static com.codefew.util.ScrollBoundaryUtil.canScrollUp;
import static com.codefew.util.ScrollBoundaryUtil.isTransformedTouchPointInView;
...
public class RefreshContentWrapper implements RefreshContentable {
    ...
    protected void wrapperCoordinatorLayout(ViewGroup layout, final Refreshable refreshLayout) {
    ...
    @Override
    public void flying(int velocity) {
